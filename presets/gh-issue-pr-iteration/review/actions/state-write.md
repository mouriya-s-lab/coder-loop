...
```bash
coder-loop item update <CHAIN_NAME> --item <ISSUE> --status <status> [--field-json '{"pr":123,"branch":"<name>"}']
```
...
```bash
coder-loop item update <CHAIN_NAME> --item <ISSUE> --status <status> --json
```
