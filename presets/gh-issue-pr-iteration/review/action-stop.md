...
- For an accepted PR GitHub side effect failure, append a handoff note with the accepted verdict, failed command, target repo/PR/issue, command output, and why rerunning would repeat the same infrastructure boundary.
