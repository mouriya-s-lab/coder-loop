...
- the four-layer evidence packet from this run's verification (Layer 1 Change preview / Layer 2 Landing checks / Layer 3 Startup / Layer 4 End-to-end + `Analysis`), including CI detection + parity status and the test-inventory delta line;
