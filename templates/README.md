...
| `templates/skills/coder-loop/SKILL.md` | user-home skill copy（如 `~/.agents/skills/coder-loop/SKILL.md`） | repo-owned coder-loop 操作 skill 模板；同步 daemon / chain / item / patrol / diagnostics command contract |
