...
Iteration must not create child issues, link sub-issues, merge PRs, close issues, stop the loop-control mechanism, reorder/prepend queue items, or mark final local state, regardless of `ISSUE_KIND`.
